...
('NHL', 'Arizona', 'Coyotes', 'Central Atlantic'),
('NHL', 'Chicago', 'Blackhawks', 'Central Atlantic'),
('NHL', 'Colorado', 'Avalanche', 'Central Atlantic'),
('NHL', 'Dallas', 'Stars', 'Central Atlantic'),
('NHL', 'Minnesota', 'Wild', 'Central Atlantic'),
('NHL', 'Nashville', 'Predators', 'Central Atlantic'),
('NHL', 'St. Louis', 'Blues', 'Central Atlantic'),
('NHL', 'Winnipeg', 'Jets', 'Central Atlantic'),
('NHL', 'Anaheim', 'Ducks', 'Central Pacific'),
('NHL', 'Calgary', 'Flames', 'Central Pacific'),
('NHL', 'Edmonton', 'Oilers', 'Central Pacific'),
('NHL', 'Los Angeles', 'Kings', 'Central Pacific'),
('NHL', 'San Jose', 'Sharks', 'Central Pacific'),
('NHL', 'Seattle', 'Kraken', 'Central Pacific'),
('NHL', 'Vancouver', 'Canucks', 'Central Pacific'),
('NHL', 'Vegas', 'Golden Knights', 'Central Pacific'),
...
('NBA', 'Atlanta', 'Hawks', 'Southeast'),
('NBA', 'Charlotte', 'Hornets', 'Southeast'),
('NBA', 'Miami', 'Heat', 'Southeast'),
('NBA', 'Orlando', 'Magic', 'Southeast'),
('NBA', 'Washington', 'Wizards', 'Southeast'),
('NBA', 'Boston', 'Celtics', 'Atlantic'),
('NBA', 'Brooklyn', 'Nets', 'Atlantic'),
('NBA', 'New York', 'Knicks', 'Atlantic'),
('NBA', 'Philadelphia', '76ers', 'Atlantic'),
('NBA', 'Toronto', 'Raptors', 'Atlantic'),
('NBA', 'Chicago', 'Bulls', 'Central'),
('NBA', 'Cleveland', 'Cavaliers', 'Central'),
('NBA', 'Detroit', 'Pistons', 'Central'),
('NBA', 'Indiana', 'Pacers', 'Central'),
('NBA', 'Milwaukee', 'Bucks', 'Central'),
('NBA', 'Dallas', 'Mavericks', 'Southwest'),
('NBA', 'Houston', 'Rockets', 'Southwest'),
('NBA', 'Memphis', 'Grizzlies', 'Southwest'),
('NBA', 'New Orleans', 'Pelicans', 'Southwest'),
('NBA', 'San Antonio', 'Spurs', 'Southwest'),
('NBA', 'Denver', 'Nuggets', 'Northwest'),
('NBA', 'Minnesota', 'Timberwolves', 'Northwest'),
('NBA', 'Oklahoma City', 'Thunder', 'Northwest'),
('NBA', 'Portland', 'Trail Blazers', 'Northwest'),
('NBA', 'Utah', 'Jazz', 'Northwest'),
('NBA', 'Golden State', 'Warriors', 'Pacific'),
('NBA', 'Los Angeles', 'Clippers', 'Pacific'),
('NBA', 'Los Angeles', 'Lakers', 'Pacific'),
('NBA', 'Phoenix', 'Suns', 'Pacific'),
('NBA', 'Sacramento', 'Kings', 'Pacific'),
...
('NCAA', 'BYU', 'Cougars', 'Big 12'),
('NCAA', 'Houston', 'Cougars', 'Big 12'),
('NCAA', 'FCU', 'Owls', 'Big 12'),
('NCAA', 'Cincinnati', 'Bearcats', 'Big 12');
...
('NCAA', 'Boston College', 'Eagles', 'ACC'),
('NCAA', 'Clemson', 'Tigers', 'ACC'),
('NCAA', 'Duke', 'Blue Devils', 'ACC'),
('NCAA', 'Florida State', 'Seminoles', 'ACC'),
('NCAA', 'Georgia Tech', 'Yellow Jackets', 'ACC'),
('NCAA', 'Louisville', 'Cardinals', 'ACC'),
('NCAA', 'Miami', 'Hurricanes', 'ACC'),
('NCAA', 'North Carolina', 'Tar Heels', 'ACC'),
('NCAA', 'North Carolina State', 'Wolfpack', 'ACC'),
('NCAA', 'Notre Dame', 'Fighting Irish', 'ACC'),
('NCAA', 'Pittsburgh', 'Panthers', 'ACC'),
('NCAA', 'Syracuse', 'Orange', 'ACC'),
('NCAA', 'Virginia', 'Cavaliers', 'ACC'),
('NCAA', 'Virginia Tech', 'Hokies', 'ACC'),
('NCAA', 'Wake Forest', 'Demon Deacons', 'ACC'),
('NCAA', 'Illinois', 'Fighting Illini', 'Big 10'),
('NCAA', 'Indiana', 'Hoosiers', 'Big 10'),
('NCAA', 'Iowa', 'Hawkeyes', 'Big 10'),
('NCAA', 'Maryland', 'Terrapins', 'Big 10'),
('NCAA', 'Michigan', 'Wolverines', 'Big 10'),
('NCAA', 'Michigan State', 'Spartans', 'Big 10'),
('NCAA', 'Minnesota', 'Golden Gophers', 'Big 10'),
('NCAA', 'Nebraska', 'Cornhuskers', 'Big 10'),
('NCAA', 'Northwestern', 'Wildcats', 'Big 10'),
('NCAA', 'Ohio State', 'Buckeyes', 'Big 10'),
('NCAA', 'Penn State', 'Nittany Lions', 'Big 10'),
('NCAA', 'Purdue', 'Boilermakers', 'Big 10'),
('NCAA', 'Rutgers', 'Scarlet Knights', 'Big 10'),
('NCAA', 'Wisconsin', 'Badgers', 'Big 10');
('NCAA', 'Butler', 'Bulldogs', 'Big East'),
('NCAA', 'Creighton', 'Bluejays', 'Big East'),
('NCAA', 'DePaul', 'Blue Demons', 'Big East'),
('NCAA', 'Georgetown', 'Hoyas', 'Big East'),
('NCAA', 'Marquette', 'Golden Eagles', 'Big East'),
('NCAA', 'Providence', 'Friars', 'Big East'),
('NCAA', 'Seton Hall', 'Pirates', 'Big East'),
('NCAA', 'St. John''s', 'Red Storm', 'Big East'),
('NCAA', 'Villanova', 'Wildcats', 'Big East'),
('NCAA', 'Xavier', 'Musketeers', 'Big East'),
('NCAA', 'Cincinnati', 'Bearcats', 'Big East'),
('NCAA', 'Connecticut', 'Huskies', 'Big East'),
('NCAA', 'Louisville', 'Cardinals', 'Big East'),
('NCAA', 'Syracuse', 'Orange', 'Big East');